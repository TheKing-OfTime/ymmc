          ...
          <div className="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex gap-3 items-center">
              <Link
                ...
                isExternal
                className="px-3 py-1.5 rounded-full bg-white/20 dark:bg-black/20 hover:bg-white/30 dark:hover:bg-black/30 backdrop-blur-sm transition-all flex items-center gap-2 text-sm font-medium"
              >
              ...
              <Link
                ...
                isExternal
                className="px-3 py-1.5 rounded-full bg-[#5865F2] hover:bg-[#4752C4] transition-all flex items-center gap-2 text-sm font-medium"
              >
